...
* 05.06
  - 회사 이사 준비 및 정리
* 05.07
  - IoT 카메라 클라이언트 원격 관리 메뉴얼 제작 (김기훈 인턴)
  - 현장실습 중간발표자료 제출

## 11주차 (05.10 ~ 05.14)
* IoT 카메라 클라이언트 원격 관리 (김기훈 인턴)
* 05.10
  - Local Manager PCB를 수정하여 Central Manager PCB 제작
* 05.11
  - aParkings-AI를 위한 Jetson Nano 개발 환경 재준비
* 05.12
  - aParkings-AI 개발 준비 완료, aParkings-DDS 제작 준비
* 05.13
  - aPs-AI 개발, IoT 카메라 클라이언트 웹 컴퓨터 복구
* 05.14
  - aPs-AI 개발
...
* IoT 카메라 클라이언트 원격 관리 (김기훈 인턴)
* 05.17 ~ 05.18
  - aPs-AI 개발, aPs-AI 1차 중간 발표 자료 제작
* 05.19 석가탄신일 卍
* 05.20
  - aPs-AI 개발, aPs-AI 1차 중간 발표
* 05.21
  - aPs-AI 개발: 라즈베리파이(카메라)-젯슨나노(서버,영상처리)-안드로이드(UI) 연결 테스트 완료
  - 12주차 보고서 제출
